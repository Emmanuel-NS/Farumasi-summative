...
class _MedicineDetailScreenState extends State<MedicineDetailScreen>
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      spacing: 8,
                      children: widget.medicine.allCategories
                          .take(3)
                          .map(
                            (cat) => Container(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            if (widget.medicine.maxPrice != null &&
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    context.read<CartBloc>().add(
                      AddToCart(widget.medicine, quantity: _quantity),
                    );
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        "Add  •  ${(widget.medicine.price * _quantity).toStringAsFixed(0)} RWF",
                        style: const TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 16,
                          color: Colors.white,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _buildInfoChip(
                ...
                "Exp: ${widget.medicine.expiryDate ?? 'N/A'}",
                Colors.blue,
              ),
              const SizedBox(width: 12),
          ...
          if (widget.medicine.allSubCategories.isNotEmpty) ...[
            ...
            Wrap(
              spacing: 8,
              children: widget.medicine.allSubCategories
                  .map(
                    (sub) => Chip(
  ...
  Widget _buildDosageTab() {
    bool hasStructured =
        widget.medicine.doseMorning != null ||
        widget.medicine.doseTimeInterval != null;
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(color: Colors.blue.shade800, height: 1.4),
                  ),
                ),
              ],
            ),
          ...
          if (hasStructured) ...[
            ...
            Row(
              ...
              children: [
                _buildDoseTime(
                  "Morning",
                  widget.medicine.doseMorning,
                  Icons.wb_sunny_outlined,
                ),
                _buildDoseTime(
                  "Noon",
                  widget.medicine.doseAfternoon,
                  Icons.wb_twilight,
                ),
                _buildDoseTime(
                  "Night",
                  widget.medicine.doseEvening,
                  Icons.nights_stay_outlined,
                ),
              ],
            ),
            const SizedBox(height: 24),
            if (widget.medicine.doseTimeInterval != null &&
                widget.medicine.doseTimeInterval!.isNotEmpty)
              Center(
                child: Text(
                  "Interval: ${widget.medicine.doseTimeInterval}",
                  style: const TextStyle(
                    fontWeight: FontWeight.bold,
                    color: Colors.grey,
                  ),
  ...
  Widget _buildDoseTime(String time, String? amount, IconData icon) {
    bool isActive =
        amount != null && amount.isNotEmpty && amount.toLowerCase() != "none";
    return Column(
      children: [
        Container(
          width: 60,
