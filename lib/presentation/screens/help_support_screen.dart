    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildFaqGroup("Account & Payments", [
            _FaqItem(
            ...
            _FaqItem(
              "Is my data safe?",
              "Yes, we use military-grade encryption to protect your health data.",
            ),
          ]),

          _buildFaqGroup("Medical Services", [
            _FaqItem(
